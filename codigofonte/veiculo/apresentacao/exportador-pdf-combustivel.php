...
$loLista =  $loPercDados->ListaCombustivel($loDadosC);
...
if(count($loLista) > 0 ){
    ...
    foreach ($loLista as $row){
         ...
         $loHtmlConteudo .= " <td style='border-collapse: collapse;border:1px solid #000000;padding: 3px' > ".$row["id_combustivel"]." </td>";
