...
(function () {
    ...
    pub.CarregaDados = function (){
        ...
        $.ajax({
                ...
                , type: "POST"
                , url: "consulta-tipo-logradouro-ajax.php"
    ...
    pub.AbrirItem = function (id){
        ...
        window.location.href = "adicionar-tipo-logradouro.php?acao=U&id=" + id + "&id_menu=" + IDMenu;
    };
    //funções pub end
    ...
    priv.buttonExportarPdf_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-pdf-regioes.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    priv.buttonExportarExcel_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-excel-regioes.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    ...
    priv.buttonPesquisa_onClick = function (){
       ...
       var IDMenu = $("#id-menu").val();
        ...
        if(loStatus == ""){
            ...
            window.location.href = "consulta-tipo-logradouro.php?id_menu="+IDMenu+"&status="+loStatus;
        }         
    ...
    priv.buttonAdicionar_onClick = function () {
        var IDMenu = $("#id-menu").val();
        window.location.href = "adicionar-tipo-logradouro.php?acao=I&id_menu="+IDMenu;
    };

   priv.buttonCancelar_onClick = function () {
       var IDMenu = $("#id-menu").val();
        window.location.href = "consulta-tipo-logradouro.php?id_menu="+IDMenu;
    };
    ...
    priv.buttonGravarDados_onClick = function () {
        ...
        $.ajax({
            ...
            , type: "POST"
            , dataType: "json"
            , url: "gravar-tipo-logradouro.ajax.php"
            , success: function (retorno) {
               ...
               if(retorno.erro){
                    ...
                    var IDMenu = $("#id-menu").val();
                    window.location.href = "../../gerenciaCadastros/apresentacao/consulta-tipo-logradouro.php?id_menu="+IDMenu;
               }
