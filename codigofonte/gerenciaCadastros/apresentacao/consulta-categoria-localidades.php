...
<?php  include("../negocio-categoria-localidades.php");  ?>
...
<html>
    ...
    <body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> Categoria Localidade</span>
                                    </div>
                                ...
                                <form class="form-inline" role="form" id="form-filtro">
                                        ...
                                        <div class="checkbox">
                                         ...
                                         <input type="hidden" name="nomenclatura" id="nomenclatura" value="RelatorioCategoriaLocalidade" />
                                         <input type="hidden" name="titulo" id="titulo" value="Relatorio Categoria Localidade" /> 
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php include("consulta-categoria-localidades-ajax.php"); ?>
        ...
        <?php include("../../comum/apresentacao/scripts.php"); ?>
         ...
         <script src="js/categoria-localidades.js" type="text/javascript"></script>
