...
(function () {
    ...
    pub.AbrirItem = function (id){
        ...
        window.location.href = "adicionar-setor.php?acao=U&id=" + id + "&id_menu=" + IDMenu;
    };
    //funções pub end
    ...
    priv.buttonExportarPdf_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-pdf-setor.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    priv.buttonExportarExcel_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-excel-setor.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    ...
    priv.buttonPesquisa_onClick = function (){
       ...
       var IDMenu = $("#id-menu").val();
        ...
        if(loStatus == ""){
            ...
            window.location.href = "consulta-setor.php?id_menu="+IDMenu+"&status="+loStatus;
        }        
    ...
    priv.buttonAdicionar_onClick = function () {
        var IDMenu = $("#id-menu").val();
        window.location.href = "adicionar-setor.php?acao=I&id_menu="+IDMenu;
    };

   priv.buttonCancelar_onClick = function () {
       var IDMenu = $("#id-menu").val();
        window.location.href = "consulta-setor.php?id_menu="+IDMenu;
    };
        ...
        $.ajax({
            ...
            , success: function (retorno) {
               ...
               if(retorno.erro){
                    ...
                    var IDMenu = $("#id-menu").val();
                    window.location.href = "../../gerenciaCadastros/apresentacao/consulta-setor.php?id_menu="+IDMenu;
               }
