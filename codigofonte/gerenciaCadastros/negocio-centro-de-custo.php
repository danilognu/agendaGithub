<?php
include('persistencia-centro-de-custo.php');

class centroDeCustoBO{
    ...
    public function Consultar($loDados){
        ...
        if(isset($loDados["id"]) && !empty($loDados["id"]) ){
            $loId = $loDados["id"];
            $loDdConsulta .=  " AND id_centro_custo = ".$loId; 
        ...
        $loConsultar = new centroDeCustoBOA();
    ...
    public function Gravar($loDados){
        ...
        if($loDados["nome"] == ""){ 
            ...
            $loResultadoMessagem = "Favor preencher o Nome do Centro de Custo.";
