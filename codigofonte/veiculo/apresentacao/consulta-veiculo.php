                       ...
                       <!-- BEGIN EXAMPLE TABLE PORTLET-->
                         ...
                         <form class="form-inline" role="form" id="form-filtro">
                                           ...
                                           <div class="form-group">
                                                 ...
                                                 <div class="col-md-3">
                                                    <input type="text" id="filtro-placa" class="form-control" size="10" name="placa" >
                                                </div>                                           
                                           </div>
                                             ...
                                             <div class="form-group">
                                                 ...
                                                 <div class="col-md-3">
                                                    <input type="text" id="filtro-chassi" class="form-control" size="20" name="chassi" >
                                                </div>                                           
                                           </div>
                                        ...
                                        <div class="checkbox">
                                           ...
                                           <input type="hidden" name="nomenclatura" id="nomenclatura" value="Veiculo" /> 
                                           <input type="hidden" name="titulo" id="titulo" value="Relatorio Veiculo" />   
                                        ...
                                        <div class="col-md-5">
                                                ...
                                                <div class="btn-group pull-right">
                                                    ...
                                                    <ul class="dropdown-menu pull-right">
                                                            ...
                                                            <?php
                                                                $loGridItens =  $loVeiculo->GridConsultaItens($IdMenu);
                                ...
                                <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        <thead>
                                            <tr>
                                                ...
                                                $loItensConsulta =  $loVeiculo->ListaItensConsulta($loDadosC);
                                        ...
                                        <?php include("consulta-veiculo-ajax.php"); ?>
