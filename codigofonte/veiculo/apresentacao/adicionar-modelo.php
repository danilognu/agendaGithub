...
{
    $loIdModelo = $_REQUEST["id"];

    
    $loDadosC = array( 'nome' => '', 'id' => $loIdModelo );
                    ...
                    <!-- BEGIN SAMPLE FORM PORTLET-->
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        <i class="fa fa-car"></i>
                                        <span class="caption-subject font-dark sbold uppercase">Modelo</span>
                                    </div>
                                        ...
                                        <div class="form-actions">
                                            <div class="row">
                                                <div class="col-md-offset-3 col-md-9">
                                                    ...
                                                    <input type="hidden" id="id" value="<?php echo $loIdModelo; ?>" />
                                                </div>
                                            </div>
                                        </div>
                                    </form>
