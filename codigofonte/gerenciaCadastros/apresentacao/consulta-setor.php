...
<html>
    ...
    <body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase"> Setor</span>
                                    </div>
                                ...
                                <form class="form-inline" role="form" id="form-filtro" >
                                        ...
                                        <div class="checkbox">
                                         ...
                                         <input type="hidden" name="nomenclatura" id="nomenclatura" value="RelatorioSetor" />
                                         <input type="hidden" name="titulo" id="titulo" value="Relatorio Setor" />                                                      
                                    </form>
                                    <br />
                                    <br />
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php include("consulta-setor-ajax.php"); ?>
        ...
        <?php include("../../comum/apresentacao/scripts.php"); ?>
         ...
         <script src="js/setor.js" type="text/javascript"></script>
