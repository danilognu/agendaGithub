...
$arTabela = array("id_combustivel", "nome", "ativo");
...
$loLista =  $loCombustivel->ListaCombustivel($loDadosC);
    ...
    foreach ($loLista as $row){
            ...
            $coluna = 0;
             foreach ($arTabela as $nomeColuna){
               ...
               $objPHPExcel->getActiveSheet()->setCellValueByColumnAndRow($coluna, $linha, utf8_encode($row[$nomeColuna]) );
