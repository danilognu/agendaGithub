                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        <i class="fa fa-car"></i>
                                        <span class="caption-subject bold uppercase"> Modelo</span>
                                    </div>
                                ...
                                <form class="form-inline" role="form" id="form-filtro" >
                                    <input type="hidden" nome="id-menu" id="id-menu" value="<?php echo $IdMenu; ?>" />
                                           ...
                                           <div class="form-group">
                                                 ...
                                                 <div class="col-md-3">
                                                    <input type="text" name="nome" id="filtro-nome-modelo" class="form-control" size="50" >
                                                </div>                                           
                                           </div>
                                        ...
                                        <div class="checkbox">
                                         ...
                                         <input type="hidden" name="nomenclatura" id="nomenclatura" value="RelatorioModelo" />
                                         <input type="hidden" name="titulo" id="titulo" value="Relatorio Modelo" />                                                    
                                    </form>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <tbody id="conteudo">
                                           ...
                                           <?php include("consulta-modelo-ajax.php"); ?>
