...
(function () {
    ...
    pub.CarregaDados = function (){
        ...
        $.ajax({
                ...
                , type: "POST"
                , url: "consulta-categoria-localidades-ajax.php"
    ...
    pub.AbrirItem = function (id){
        ...
        window.location.href = "adicionar-categoria-localidades.php?acao=U&id=" + id + "&id_menu=" + IDMenu;
    };
    //funções pub end
    ...
    priv.buttonExportarPdf_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-pdf-categoria-localidades.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    priv.buttonExportarExcel_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-excel-categoria-localidades.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    ...
    priv.buttonPesquisa_onClick = function (){
       ...
       var IDMenu = $("#id-menu").val();
        ...
        if(loStatus == ""){
            ...
            window.location.href = "consulta-categoria-localidades.php?id_menu="+IDMenu+"&status="+loStatus;
        }         
    ...
    priv.buttonAdicionar_onClick = function () {
        var IDMenu = $("#id-menu").val();
        window.location.href = "adicionar-categoria-localidades.php?acao=I&id_menu="+IDMenu;
    };

   priv.buttonCancelar_onClick = function () {
       var IDMenu = $("#id-menu").val();
        window.location.href = "consulta-categoria-localidades.php?id_menu="+IDMenu;
    };
    ...
    priv.buttonGravarDados_onClick = function () {
        ...
        $.ajax({
            ...
            , type: "POST"
            , dataType: "json"
            , url: "gravar-categoria-localidades.ajax.php"
            , success: function (retorno) {
               ...
               if(retorno.erro){
                    ...
                    var IDMenu = $("#id-menu").val();
                    window.location.href = "../../gerenciaCadastros/apresentacao/consulta-categoria-localidades.php?id_menu="+IDMenu;
               }
