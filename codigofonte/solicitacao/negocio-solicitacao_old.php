...
class solicitacaoBO{
    ...
    public function EnviarEmailAtorizacaoMotorista($mbDados){
        ...
        try {
            ...
            // Remetente
            $mail->AddReplyTo('lets@Lets.com', 'Agendamento Lets');
            $mail->SetFrom('lets@Lets.com.br', 'Agendamento Lets');
   ...
   public function ListaRequisitante($loDados){
    ...
    public function EmailCarona($mbDados,$mbStatus){
        ...
        try {
            ...
            // Remetente
            $mail->AddReplyTo('lets@Lets.com.br', utf8_decode('Solicitação de Carona'));
            $mail->SetFrom('lets@Lets.com.br', utf8_decode('Solicitação de Carona'));
    ...
    public function EncaminharEmailAprovacao($mbIdSolicitacao){
        ...
        if($loEmailRequisitante != ""){
            ...
            $loMessagemHTML = "<strong> Solicitação de Número:</strong> $mbIdSolicitacao <strong> foi Aprovada.  </strong>
 ...
 public function EncaminharEmailNaoAprovacao($mbIdSolicitacao){
        ...
        if($loEmailRequisitante != ""){
            ...
            try {
                ...
                // Remetente
                $mail->AddReplyTo('lets@Lets.com.br', utf8_decode('Solicitação Não Aprovada'));
                $mail->SetFrom('lets@Lets.com.br', utf8_decode('Solicitação Não Aprovada'));
    ...
    public function EncaminharGestorAutorizador($mbIdSolicitacao){
        ...
        if(count($loDadosAutorizador) > 0){
            ...
            try {
                ...
                // Remetente
                $mail->AddReplyTo('lets@Lets.com.br', utf8_decode('Solicitação de Aprovação de Viagem'));
                $mail->SetFrom('lets@Lets.com.br', utf8_decode('Solicitação de Aprovação de Viagem'));
