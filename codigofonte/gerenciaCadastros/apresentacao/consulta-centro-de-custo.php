...
<?php  include("../negocio-centro-de-custo.php");  ?>
...
<html>
    ...
    <body class="page-container-bg-solid page-boxed">
                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption font-dark">
                                        ...
                                        <span class="caption-subject bold uppercase">Centro de Custo</span>
                                    </div>
                                ...
                                <div class="portlet-body">
                                    ...
                                    <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                        ...
                                        <?php include("consulta-centro-de-custo-ajax.php"); ?>
        ...
        <?php include("../../comum/apresentacao/scripts.php"); ?>
         ...
         <script src="js/centro-de-custo.js" type="text/javascript"></script>
