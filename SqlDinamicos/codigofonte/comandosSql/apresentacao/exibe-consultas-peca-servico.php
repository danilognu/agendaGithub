            ...
            <div class="page-content-wrapper">
                ...
                <div class="page-content">
                   ...
                   <?php
                         ...
                         $loDadosComandos = $loNegociosComandos->ListaPecaServico();
                    ?>
                            ...
                            <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">
                                <thead>
                                    <tr>
                                            ...
                                            <th style="width:01%"> <input type="checkbox" class="group-checkable" data-set="#sample_1 .checkboxes" /> </th>
                                            <th style="width:10%"> Pe&ccedil;a / Servi&ccedil;o </th>
                                ...
                                <?php
                                        ...
                                        foreach ($loDadosComandos as $row) {
                                            ...
                                            echo "<tr class='tableConsultaLaudo odd gradeX' id='' style='cursor: pointer' >";
                                            echo "<td style='width:01%'>  <input type='checkbox' class='checkboxes' name='' value='' />  </td>";
                                            echo "<td>". $row["A215_nom_peca"] ."</td>"; 
                                            echo "<td>". $row["tipoPeca"] ."</td>";  
                                            echo "<td>". $row["A213_nom_grupo"] ."</td>";
