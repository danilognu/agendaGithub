                                ...
                                <form class="form-inline" role="form"  id="form-filtro">
                                        ...
                                        <div class="form-group">
                                                ...
                                                <div class="col-md-2">
                                                    ...
                                                    <input type="text" id="filtro-codigo-cliente" class="form-control mask_number" name="id" size="5" >

                                                </div>
                                                <div class="col-md-5">
                                                    <input type="text" id="filtro-nome-cliente" class="form-control" name="nome" size="25" >
                                                </div>
                                                <div class="col-md-1">
                                           ...
                                           <div class="form-group">
                                                 ...
                                                 <div class="col-md-3">
                                                    <input type="text" id="filtro-cnpj-cliente" class="form-control mask_cnpj" name="cnpj" size="20" >
                                                </div>                                           
                                           </div>
                                        ...
                                        <div class="checkbox">
                                         ...
                                         <input type="hidden" name="nomenclatura" id="nomenclatura" value="Cliente" />
                                         <input type="hidden" name="tipo-pessoa" id="tipo-pessoa" value="2" /> 
                                         <input type="hidden" name="titulo" id="titulo" value="Relatorio Cliente" />         
                                    </form>
