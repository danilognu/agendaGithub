...
MotivoNaoPanejamento = {};

(function () {
    var pub = MotivoNaoPanejamento;
    ...
    pub.CarregaDados = function (){
        ...
        $.ajax({
                ...
                , type: "POST"
                , url: "consulta-motivo-nao-planejamento-ajax.php"
    ...
    pub.AbrirItem = function (id){
        ...
        window.location.href = "adicionar-motivo-nao-planejamento.php?acao=U&id=" + id + "&id_menu=" + IDMenu;
    };
    //funções pub end
    ...
    priv.buttonExportarPdf_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-pdf-motivo-nao-planejamento.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    priv.buttonExportarExcel_onClick = function (){
        $("#form-filtro").attr('action', 'exportador-excel-motivo-nao-planejamento.php');
        $("#form-filtro").attr('target', '_self').submit();
    };
    ...
    priv.buttonPesquisa_onClick = function (){
       ...
       var IDMenu = $("#id-menu").val();
        ...
        if(loStatus == ""){
            ...
            window.location.href = "consulta-motivo-nao-planejamento.php?id_menu="+IDMenu+"&status="+loStatus;
        }          
    ...
    priv.buttonAdicionar_onClick = function () {
        var IDMenu = $("#id-menu").val();
        window.location.href = "adicionar-motivo-nao-planejamento.php?acao=I&id_menu="+IDMenu;
    };

   priv.buttonCancelar_onClick = function () {
       var IDMenu = $("#id-menu").val();
        window.location.href = "consulta-motivo-nao-planejamento.php?id_menu="+IDMenu;
    };
    ...
    priv.buttonGravarDados_onClick = function () {
        ...
        $.ajax({
            ...
            , type: "POST"
            , dataType: "json"
            , url: "gravar-motivo-nao-planejamento.ajax.php"
            , success: function (retorno) {
               ...
               if(retorno.erro){
                    ...
                    var IDMenu = $("#id-menu").val();
                    window.location.href = "../../gerenciaCadastros/apresentacao/consulta-motivo-nao-planejamento.php?id_menu="+IDMenu;
               }
