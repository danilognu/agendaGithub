...
$loGrupoAcessoUserRota = $loSolicitacao->VerificaGrupoAcessoUsuario();
if($loGrupoAcessoUserRota["ind_usuario"] == 1 || $loGrupoAcessoUserRota["ind_gestor"] == 1){
    $loDisabledUsuarioGestorRota = "disabled";
}
...
<table class="table table-hover tabela-rota-atendimento"   >
    ...
    <?php
            ...
            ?>
                                    ...
                                    <td> <input type="text" class="form-control input-sm mask_date_hora" name="data-partida"  value="<?php echo $rowDestino["dt_partida"]; ?>"  > </td>
                                    ...
                                    <td>
                                        <button type="button" name="salvar" <?php echo $loDisabledUsuarioGestorRota; ?> class="btn dark" onClick="Solicitacao.RotaItensDestino(this);"  > <i class="fa fa-save"></i></button>
                                        <button type="button" name="excluir" <?php echo $loDisabledUsuarioGestorRota; ?> class="btn dark" onClick="Solicitacao.ExcluirDestino(this);"  > <i class="fa fa-times-circle"></i></button>
                                    </td>
                                </tr>
