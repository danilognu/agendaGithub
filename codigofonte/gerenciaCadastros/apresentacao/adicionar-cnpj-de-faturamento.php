                            ...
                            <div class="portlet light bordered">
                                <div class="portlet-title">
                                    <div class="caption">
                                        ...
                                        <span class="caption-subject font-dark sbold uppercase">Cnpj Faturamento</span>
                                    </div>
                                ...
                                <div class="portlet-body form">
                                    <form class="form-horizontal" role="form">
                                        <div class="form-body">
                                           ...
                                           <div class="form-group">
                                                <label class="col-md-3 control-label">Descri&ccedil;&atilde;o</label>
                                                <div class="col-md-9">
                                                   <input type="text" id="descricao" class="form-control" value="<?php echo $loDescricao; ?>" >
                                                  </div>
                                            </div>
